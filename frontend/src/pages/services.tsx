...
export default function ServicesPage() {
  ...
  return (
    <>
      <Head>
        <title>Услуги и цены — АвтоСервис Симферополь</title>
        <meta name="description" content="Полный прайс-лист автосервиса АвтоСервис в Симферополе. Диагностика, ТО, ходовая, тормоза, двигатель, АКПП." />
      </Head>
      <Header />
      <main>
        {/* Hero */}
