  ...
  return (
    <div className="min-h-screen bg-dark flex">
      ...
      <aside className="hidden md:flex flex-col w-60 bg-dark-100 border-r border-dark-200 shrink-0">
        <div className="p-5 border-b border-dark-200">
          <Link href="/" className="flex items-center gap-2">
            ...
            <div>
              <p className="font-bold text-sm">АвтоСервис</p>
              <p className="text-xs text-primary-400">Панель управления</p>
            </div>
          </Link>
        </div>
        ...
        <div className="p-3 border-t border-dark-200">
          <button
            ...
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-dark-300 hover:text-red-400 hover:bg-red-500/10 transition-colors w-full"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Mobile header */}
        <header className="md:hidden bg-dark-100 border-b border-dark-200 px-4 py-3 flex items-center justify-between">
          <span className="font-bold">АвтоСервис <span className="text-primary-400">Admin</span></span>
        ...
        {/* Top bar */}
        {title && (
          <div className="bg-dark-100 border-b border-dark-200 px-6 py-4">
